...
- Create Angular project with ng: `ng new items.manager.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`items.manager.client.esproj`).
